...
async function makePaymentWithRecord(amount, currency, customerId, paymentMethodId, description, requestId) {
  try {
...
module.exports = { addCard, makePaymentWithRecord, getCardDetailsByUserId, addPaymentRecord,retrieveCards};
=======
const db = require("../db");
const user = require("./user");
const Stripe = require("stripe");
...
>>>>>>> 9034cc8334767933ace9e4746f8c6caa0c8490b7
